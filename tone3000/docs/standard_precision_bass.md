ALLOMORPH: STANDARD PRECISION BASS EDITION

Transform your stock Fender P-Bass into 22 legendary active, vintage, modern, and acoustic pickup configurations.
...
Calibrated for a 34" Standard Precision Bass with stock split-coil pickups. Exact differential deconvolution neutralizes your stock pickup's loaded resonance and aperture, reconstructing each target twin in real time.
...
• Physical Volume Knob: 100% (Wide Open)
• Physical Tone Knob: 100% (Wide Open)
...
01. Modern Active Jazz Bass (NYC 2-Band)
...
02. Vintage '60s Jazz Bass Pair (Parallel)
...
03. '60s Jazz Bass Pair (22nF ToneStyler)
...
04. '60s Jazz Bridge Growl (Jaco Bias)
Models decoupled dual volumes with 55k neck wiper resistance. Pulls comb notch into vocal 550–800 Hz zone for signature Jaco bridge growl while retaining low-end body.

05. '60s Jazz Bridge Single-Coil
...
21. Modern Studio Active Buffer (Zero Cable Loading)
Studio 1M ohm active buffer twin. Deconvolves 750 pF cable capacitance and pot damping from your stock P-Bass pickup, shifting resonance to 7.5–9.0 kHz for pristine pick attack and hi-fi air.

22. Passive Character (Dynamic Baseline / True Bypass)
Bit-exact 0.00 dB flat linear response calibrated to stock P-Bass Alnico V dynamics and output staging. Serves as a transparent reference for seamless A/B comparison and unity routing.

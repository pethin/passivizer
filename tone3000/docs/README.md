...
| **Preamp Soapbar Bass Edition** | 34" Preamp Dual-Soapbar Bass (Passive Pickups + Active EQ, 22 Voicings) | Vol 100%, Active EQ Flat (Center Detents), Blend configs: `[Parallel]`, `[Neck]`, `[Bridge]` | [`preamp_soapbar_bass.txt`](preamp_soapbar_bass.txt) | [`allomorph_preamp_soapbar_bass.svg`](../assets/allomorph_preamp_soapbar_bass.svg) &bull; [JPG](../assets/allomorph_preamp_soapbar_bass.jpg) |
| **Active StingRay Bass Edition** | 34" Active Music Man StingRay / Sterling Ray34 (21 Voicings) | Vol 100%, Active EQ Flat (Center Detents) | [`active_stingray_bass.txt`](active_stingray_bass.txt) | [`allomorph_active_stingray_bass.svg`](../assets/allomorph_active_stingray_bass.svg) &bull; [JPG](../assets/allomorph_active_stingray_bass.jpg) |
...
1. **Character Limit Compliance:** Tone3000 enforces a strict maximum length of 10,000 characters per listing. All 6 packs stay safely under this ceiling.

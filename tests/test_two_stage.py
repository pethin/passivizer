"""
Allomorph - Architecture C Native Two-Stage Pipeline Test Suite
Validates the Canonical Intermediate baseline, 33 frontend IRs, 3-tier dynamic continuum,
...
from scripts.train_nam import VOICE_CONCISE_SLUGS
...
def test_bake_dynamic_tier_and_auto_pickup():
    ...
    from scripts.model_physics import get_source_pickup, compute_voice_prefilter_firs
    from scripts.simulate_circuits import simulate_voice
    import tempfile
...
def test_baked_short_distinct_names_and_instrument_directories():
    ...
    from scripts.model_physics import resolve_instruments, resolve_voices

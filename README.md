...
| **11b**| `11b_pmm_hybrid_series` | P + MM Hybrid (Series) | Series Sum | Modern $500\text{k}\Omega$ Vol/Tone, $47\text{nF}$ Cap | $7.20\text{ H}$ | $1.6\text{ kHz}$ | Split P and MM humbucker wired in passive series sum; $+5.8\text{ dB}$ inductive boost with $1.6\text{ kHz}$ punch. |

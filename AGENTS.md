...
2. **Coherence Decay & Sidewinders:** Cross-coherence decay across dual coils must transition smoothly into incoherent summation when $\lambda \le d$ (engage whenever $\Delta\text{samples} > 0$). Model sidewinder pickups (coils feeding one central pole row) as a single centered coil ($w \approx 1.25''$), never a spaced array.
